...
# Refactored Solution
# for clarities sake, not necessarily cleaner, but easier to understand
...
# 	We didn't have any real problems, it was all easy to do. We wanted to use .arity with the methods, but didn't know what class to call
...
# 	It was fun pairing through this
